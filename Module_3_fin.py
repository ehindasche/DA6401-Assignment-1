...
class NeuralNetwork:
    ...
    def __init__(self, input_size, output_size, optimizer='sgd', beta=0.9):
    ...
    def initialize_parameters(self):
        ...
        for l in range(1, len(layer_dims)): # range is from 1 as no weights before input layer (first hidden layer is layer 1 and output layer is layer L)
            ...
            # Initialize velocity for Momentum/NAG
...
nn = NeuralNetwork(input_size=784, output_size=10, optimizer='nesterov', beta=0.9)
...
nn.train(X_train, train_labels, epochs=15, lr=0.01)
